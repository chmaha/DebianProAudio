...
Following this guide will allow you to get the best possible performance on Linux for professional audio needs. Even though these steps are well-tested, it is wise to research what each step accomplishes and why (the search engine is your friend :P ). See also [https://wiki.archlinux.org/title/Professional_audio](https://wiki.linuxaudio.org/wiki/system_configuration) and https://wiki.archlinux.org/title/Professional_audio. 

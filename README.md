...
**May 2024 update:** Now we are up to pipewire v1.0.5 I feel more confident about recommending pipewire. Indeed, I'm now running it myself for pro audio work. You can build from source via the [official build instructions](https://gitlab.freedesktop.org/pipewire/pipewire/-/blob/master/INSTALL.md?ref_type=heads) or for an easier experience simply use bookworm-backports. Be sure to add youself to the pipewire group (no need for step 3).
